...
<body onload="CWASA.init();">
  ...
  <div class="container" id="loading">
    ...
    <div class="container" id="main_text">
      <div class="row">
        <div class="col-md-12 text-center">
          <p style="font-family: 'Proxima Nova'; font-size:26px; font-size:30px; margin-top:0; padding-top:0; color: #FFFFFF">Text to Indian Sign Language Translation</p>
          <p style="font-size:17px; font-family: 'Proxima Nova'; color: rgba(255, 255, 255, 0.9);">Communication Knows No Bounds</p>
        </div>
      </div>
    </div>
    ...
    <div class="container" id="avatar_wrapper" style="display:none;">
      <div class="row">
        <div class="col-md-6">
          <h2 id="hellomsg" style="font-weight:bold; color: white;">Hello ! <br> I am Max, your ISL avatar.</h2>
          <div id="leftSide" style="display:none;">

            <ul class="nav nav-tabs nav-justified" id="navi" style="background-color: #0d1a26!important;">
              <li role="presentation" style="background-color: #0d1a26!important;"><a href="#" id="menu1-h" onclick="activateTab('menu1-h', 'menu1');" style="color: 
              #0057FF!important;">English to ISL</a></li>
              <!--  <li role="presentation"><a href="#" id="menu2-h" onclick="activateTab('menu2-h', 'menu2');">Hindi to ISL</a></li> -->
              <li role="presentation"><a href="#" id="menu3-h" onclick="activateTab('menu3-h', 'menu3');" style="color: 
              #0057FF!important;">Examples</a></li>
              <!--<li role="presentation"><a href="#" id="menu4-h" onclick="activateTab('menu4-h', 'menu4');">Numbers</a></li>-->
            </ul>

            <div id="menu1">
              <br>
              <!-- <label style=" color: white;">Enter English text here</label> -->
              <textarea id="engtext" class="form-control" style="width:100%; height:80px;" placeholder="Enter Text Here" style="color: white;background-color: #000B15"><?php
              ...
              ?></textarea><br>
              <button type="button" id="playeng" class="btn btn-primary" style="background-color: #0057FF!important;">Translate</button>
            ...
            <div id="menu2">
              ...
              <button type="button" id="playhindi" class="btn btn-primary" style="background-color: #0057FF!important;">Translate</button>
            ...
            <div id="menu3" style="max-height:250px; overflow-y:scroll;">
              <br>
              <!-- <label style=" color: white!important;">Example Sentences</label> -->
              <?php
            ...
            <br><br>
            <div id="debugpane">
              <label style="color: white;">Debugger:</label>
              ...
              <div id="debugger" style="border-color:white;color: white!important;background-color: #000B15;"></div>
            </div>
        ...
        <div class="col-md-6">
          <div class="CWASAPanel av0" align="center">
            <div class="divAv av0" style="background-color: #0d1a26!important">
              <canvas class="canvasAv av0" ondragstart="return false" width="374" height="403" style="background-color: #0d1a26!important"></canvas>
            </div> 
          </div>
